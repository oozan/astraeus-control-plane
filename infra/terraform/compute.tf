  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        { name = "APP_NAME", value = "Astraeus Control Plane API" },
        { name = "ENVIRONMENT", value = var.environment },
        { name = "API_PORT", value = tostring(var.api_container_port) },
        { name = "AUTO_CREATE_SCHEMA", value = "true" }
      ]
      secrets = [
        { name = "DATABASE_URL", valueFrom = "${aws_secretsmanager_secret.app.arn}:DATABASE_URL::" },
        { name = "REDIS_URL", valueFrom = "${aws_secretsmanager_secret.app.arn}:REDIS_URL::" },
        { name = "QUEUE_NAME", valueFrom = "${aws_secretsmanager_secret.app.arn}:QUEUE_NAME::" }
      ]
    }
  ])
